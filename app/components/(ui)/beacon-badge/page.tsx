...
export default function Page() {
  return (
    <div className="space-y-12">
      <ComponentShowcase
        title="Beacon Badge"
        description="A premium status badge with a customizable beacon (ping) animation and blur reveal text."
        preview={
          <div className="flex flex-col gap-4 items-center">
            <BeaconBadge label="Live Updates" beconColor="green" />
            <BeaconBadge label="System Alert" beconColor="red" revealDirection="right" />
            <BeaconBadge label="New Components" beconColor="purple" />
            <BeaconBadge label="Static Status" beconColor="white" />
          </div>
        }
        scale={1}
        tsxCode={`"use client";
...
`}
      />
      <InstallationSection title="Installation" component={"beacon-badge"} />
    </div>
  );
}
