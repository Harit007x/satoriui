...
import ReactiveGridBackground from "@/packages/reactive-grid/reactive-grid";
  ...
  return (
    <div className="space-y-12">
      <ComponentShowcase
        ...
        preview={<ReactiveGridBackground />}
        scale={0.9}
        tsxCode={`"use client";
...
`}
      />
      <InstallationCommand title="Installation" component={"reactive-grid"} />
    </div>
  );
}
